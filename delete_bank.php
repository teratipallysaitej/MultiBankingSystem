    ...
    <div class="displaystaff_content">
       <?php include 'admin_navbar.php'?>
                ...
                <form action="editbank.php" method="POST">
                    ...
                    <table align="center">
                        <caption align='center' style='color:#2E4372'><h3><u>Bank Details</u></h3></caption>
                        <th>id</th>
                        <th>name</th>
                        <th>address</th>
                        <th>mobile</th>
                    ...
                    <table align="center" id='button'>
                        ...
                        <tr>
                            <td><input type="submit" name="submit2_id" value="DELETE BANK DETAILS" class='addstaff_button' ></td>
                        </tr>
