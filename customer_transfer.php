...
.head{
  ...
  text-align:center;
    ...
    font-weight:bold;
        ...
        $sql="SELECT * FROM $ben WHERE sender_id='$sender_id' AND status='ACTIVE'";
        ...
        $sql1="SELECT * FROM $ben WHERE sender_id='$sender_id' AND status='ACTIVE'";
        $result=  mysqli_query($conn,$sql);
        ...
        echo "<table align='center'><tr><td style='padding:5px;'><input type='submit' name='submitBtn' value='Transfer' class='addstaff_button'></td></tr></table></form>"; 
            ...
            echo "<br><br><div class='head'><h3>No Beneficiary Added with your account.</h3></div>";
        }
        ?>
    </div> 
